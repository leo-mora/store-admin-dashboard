...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <option value="empleado" <?php echo e(old('rol', $usuario->rol) == 'empleado' ? 'selected' : ''); ?>>Empleado</option>
                </select>
                <?php $__errorArgs = ['rol'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="<?php echo e(route('usuarios.index')); ?>" class="btn btn-outline-secondary px-4">
                    Cancelar
                </a>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/usuarios/edit.blade.php ENDPATH**/ ?>