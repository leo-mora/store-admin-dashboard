...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="col-md-6">
        ...
        <input
            type="text"
            name="identificacion"
            class="form-control <?php $__errorArgs = ['identificacion'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
            value="<?php echo e(old('identificacion', $cliente->identificacion ?? '')); ?>"
...
</div><?php /**PATH /var/www/resources/views/clientes/form.blade.php ENDPATH**/ ?>